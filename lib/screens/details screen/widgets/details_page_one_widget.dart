...
class DetailsPageOneWidget extends StatelessWidget {
  const DetailsPageOneWidget({
    super.key,
    required TextEditingController nameTextController,
    required TextEditingController emailTextController,
    required TextEditingController phoneNumberTextController,
  }) : _nameTextController = nameTextController, _emailTextController = emailTextController, _phoneNumberTextController = phoneNumberTextController;
